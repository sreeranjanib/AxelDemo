...
DealerDropDown(){
  ...
  this.authService.AXELPostmethod('AXELData/GetAxelVautoDealers',obj).subscribe(x =>{
    if(x !== ''){
...
SetDefaultFilters(Change){
  ...
  this.spinnerService.show();
  this.authService.AXELPostmethod('AXELData/GetAxelVautoInvDataQueryDropdowns',obj).subscribe(x =>{
...
GridBind(){
 ...
 if(this.STORETYPE_Change == "NEW"){
  ...
  this.spinnerService.show();
  this.authService.AXELPostmethod('AXELData/GetAxelVautoInventoryDataQuery',obj).subscribe(x =>{
