    ...
    const obj = {
            ...
            this.authService.AXELPostmethod('Login/GetADUsers', obj).subscribe(x =>{
              if (x.status == 200){
                ...
                {  
                  ...
                  if(this.storeids.includes("0"))
                  {
                    this.storeids= this.storeids.filter(item => item !== "0");
                    this.allStores='Y';
                  }
      ...
      UpdateUser(){
        ...
        const obj = {
          ...
          "AU_AS_CORA_ACCT_IDs": this.SelectedStoreIds,
          ...
          console.log('Update/Insert objY',obj);
          // this.authService.AXELPostmethod('Login/UpdateADUsers', obj).subscribe(x =>{
          this.authService.AXELPostmethod('Login/UpdateADUsersTest', obj).subscribe(x =>{
            if (x.status == 200) {
