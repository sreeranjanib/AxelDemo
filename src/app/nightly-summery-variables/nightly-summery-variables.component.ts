...
@Component({
  selector: 'app-nightly-summery-variables',
  templateUrl: './nightly-summery-variables.component.html',
  styleUrls: ['./nightly-summery-variables.component.scss']
})
export class NightlySummeryVariablesComponent implements OnInit {
  Vrbleform: FormGroup;
